<div id="tabs">
  <ul>
    <li class="tab1"><a href="#bereich1">Bereich 1</a></li>
    <li class="tab2"><a href="#bereich2">Bereich 2</a></li>
    <li class="tab3"><a href="#bereich3">Bereich 3</a></li>
    <li class="tab4"><a href="#bereich4">Bereich 4</a></li>
    <li class="weiteres" style="float:right;"><a href="#weiteres">Weitere Einstellungen</a></li>
  </ul>
